...
<cfset variables.email_sent_to = variables.winner_after_email>
<cfmail
            to = "#variables.winner_after_email#"
...
Congratulations #variables.winner_after_first# #variables.winner_after_last_full#   
   
You piggybacked on the winner this month. Your check will be mailed to the address you provided when you enrolled. Thank you for supporting our school through your participation in the raffle.   
            ...
            <tr>
                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: ##555555;">
                    <h1 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 25px; line-height: 30px; color: ##333333; font-weight: normal;">
                        Congratulations #variables.raffle_winner_after#
                    </h1>
                    <p>
                        You piggybacked on the winner this month. Your check will be mailed to the address you provided when you enrolled. Thank you for supporting our school through your participation in the raffle.
                    </p>
                        ...
                        <tr>
                            <td align="center" width="33%"  style="border: 1px dotted ##555555; padding: 20px; margin: 0; height: 100%;">
                                <div>
                                    ...
                                    <p style="margin: 0; text-align:center; font-family: sans-serif; font-size:21px;">#variables.raffle_winner_before#</p>
                            ...
                            <td align="center" width="33%"  style="border: 1px dotted ##555555; padding: 20px; margin: 0; height: 100%;">
                                <div>
                                    ...
                                    <p style="margin: 0; text-align:center; font-family: sans-serif; font-size:21px;">#variables.raffle_winner#</p>
                            ...
                            <td align="center" width="33%" style="border: 1px solid ##b81413; padding: 20px; margin: 0; height: 100%;">
                                <div>
                                    <p style="margin: 0; text-align:center; font-family: sans-serif; font-size:18px;">$50</p>
                                    <p style="margin: 0; text-align:center; font-family: sans-serif; font-size:21px;">#variables.raffle_winner_after#</p>
