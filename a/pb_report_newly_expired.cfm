	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title">Entries Expired in the last 30 Days</strong></h2>
						...
						<div class="entry">
                            ...
                            <table border="1" cellpadding="2" cellspacing="0" align="center" width="150%">
                                <tr bgcolor="lightgrey">
                                    <th style="font-size:16px" align="center" colspan="8">Current Raffle Entries&nbsp;&nbsp;<span style="color:teal"><cfoutput>(#variables.sort_display#)</cfoutput></span></th>
                                </tr>
                                <tr bgcolor="lightgrey">
                                    <th><a href="pb_report_newly_expired.cfm?sort_order=name">Name</a></th>
                                    <th>Address</th>
                                    <th>Email</th>
                                    <th>Phone</th>
                                    <th>Ticket Qty</th>
                                    <th>Donation</th>
                                    <th><a href="pb_report_newly_expired.cfm?sort_order=start_date">Start Date</a></th>
                                    <th><a href="pb_report_newly_expired.cfm?sort_order=end_date">End Date</a></th>
                                </tr>
                               <cfif selCurrentDonors.RecordCount is 0>                                
                                	<tr>
                                    	<td style="font-size:20px; text-align:center" colspan="8">No Entries expired in the last 30 days!</td>
                                    </tr>
                                <cfelse>
