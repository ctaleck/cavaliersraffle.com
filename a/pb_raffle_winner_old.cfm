...
<!--- Put focus on the winning number text box --->
<cfif NOT IsDefined("form.winning_number")>
	<body onLoad="document.quote_request.winning_number.focus();">
 <!--- Syntax is: document.FormName.FieldName.focus(); --->
<cfelse>
	<body>
</cfif>
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<cfif NOT IsDefined("form.winning_number")>
                        	<h2 class="title">Winning Raffle Number Entry</strong></h2>
                        <cfelse>
                        	<h2 class="title">Winning Number and Piggybacks</strong></h2>
                        </cfif>
                        	...
                        	<cfif NOT IsDefined("form.winning_number")>
                                <cfform name="quote_request" action="pb_raffle_winner.cfm" method="post">
                                    ...
                                    <table border="0" cellpadding="3" cellspacing="3">					
                                        <tr>
                                            <th style="font-size:20px; text-align:left">Enter the Winning Raffle Number Below</th>
                                        </tr>
                                        <tr>
                                            <td align="center"> 
                                                <cfinput type="text"
                                ...
                                <h1>Raffle Number Generator</h1>
                                    ...
                                    <form method="get" action="/" onSubmit="return false;">
                                        <fieldset>
                                            <label>
                                                Eligible Raffle Numbers are Displayed<br />
                                                <textarea style="width: 500px;height: 150px;" name="things" id="things">#variables.eligible_number_list#</textarea>
                                                <br /><br /><textarea style="width: 500px;height: 150px;" name="thing" id="thing">#variables.eligible_number_list#</textarea>
                                            </label>
                                        </fieldset>
                                        <p>
                                            <input type="button" value="Get This Month's Number!" onClick="rnd();">
