    ...
    <cfmail
		to = "office@qhra.org"
        bcc = "#variables.winner_after_email#, cekweb@yahoo.com, grahekmj@gmail.com"
    ...
    <h1 style="text-align:center; font-family:'Tahoma, Geneva, sans-serif; font-size:36px">Congratulations #variables.winner_after_first#</h1>
