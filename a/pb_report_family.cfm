						...
						<div class="entry">
                            ...
                            <table border="1" cellpadding="2" cellspacing="0" align="center" width="170%">
                                <tr bgcolor="lightgrey">
                                    <th style="font-size:16px" align="center" colspan="11">Current Raffle Entries&nbsp;&nbsp;<span style="color:teal"><cfoutput>(#variables.sort_display#)</cfoutput></span></th>
                                </tr>
                                <cfoutput>
                                    <tr bgcolor="lightgrey">
                                        <th>&nbsp;</th>
                                        <!--- <th>ID</th> --->
                                        <th><a href="pb_report_family.cfm?sort_order=name&family=#URLEncodedFormat(url.family)#">Name</a></th>
                                        <th>Address</th>
                                        <th>Email</th>
                                        <th>Phone</th>
                                        <th>Ticket Qty</th>
                                        <th>Donation</th>
                                        <th><a href="pb_report_family.cfm?sort_order=start_date&family=#URLEncodedFormat(url.family)#">Start Date</a></th>
                                        <th><a href="pb_report_family.cfm?sort_order=end_date&family=#URLEncodedFormat(url.family)#">End Date</a></th>
                                        <th><a href="pb_report_family.cfm?sort_order=family&family=#URLEncodedFormat(url.family)#">Family</a></th>
                                        <th>Raffle Nbr(s)</th>
                                    </tr>
								</cfoutput>
