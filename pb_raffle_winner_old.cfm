                ...
                <cfform name="quote_request" action="pb_raffle_winner_old.cfm" method="post" class="form-inline">
                    <cfoutput>
                        ...
                        <div class="form-group mb-2">
                            <label class="form-control-label">Enter the Winning Raffle Number</label>
                            <cfinput class="form-control mx-3" type="text"
                                        name="winning_number"
                                        size="4"
                                        maxlength="5">
                        </div>
                        <cfinput class="btn btn-success mb-2" type="submit" name="submit" value="Send" validate="SubmitOnce">
                    </cfoutput>
                </cfform> 
            </div>
        </div>
                    ...
                    <div class="card card-body">
                        <form method="get" action="/" onSubmit="return false;" >
                            <div class="form-inline form-group">
                                <label class="form-control-label">Get This Month's Number</label>
                                <input class="btn btn-success mx-2" type="button" value="Generate number" onClick="rnd();">
                                <div id="result" class="form-control border-1 border-primary" style="width:5em"></div>
                                <img id="ajax-loader" class="mx-2" src="images/ajax-loader.gif" alt="Picking...">
                            </div>
                            <div class="form-group">
                                <label>Eligible Raffle Numbers are Displayed</label>
                                <textarea class="form-control" name="things" id="things">#variables.eligible_number_list#</textarea>
                                
                                <textarea class="form-control mt-3" name="thing" id="thing">#variables.eligible_number_list#</textarea>
                            </div>
                        </form> 
                    </div>
                    <p><small>Random number code based on <a href="https://developer.mozilla.org/en/Core_JavaScript_1.5_Reference/Global_Objects/Math/random" target="_blank">JavaScript documentation</a> on the Mozilla Developer Center.</small></p>
                </cfoutput>
            <script type="text/javascript">
                
                function xmpl(delimeter) {
                    var xmpls = {
                        commas:   'north, south, east, west',
                        newlines: 'north\nsouth\neast\nwest',
                        pipes:    'north|south|east|west'
                    }
                    document.getElementById('things').value = xmpls[delimeter]
                }
                ...
                <cfelse>
                    ...
                    <cfoutput>
                        ...
                        <table class="table table-sm">					
                            <tr>
                                <th>$200 Raffle Winner</th>
                                <th>$50 Piggyback (before)</th>
                                <th>$50 Piggyback (after)</th>
                            </tr>
                            <tr>
                                ...
                                <td><!--- #variables.winner_name# (#variables.winner#)<br />Donor ID = #qry_qry_winner.id# --->
                                ...
                                <td><!--- #variables.winner_name_before# (#variables.winner_before#)<br />Donor ID = #qry_qry_winner_before.id# --->
                                    <table border="0" cellpadding="1" cellspacing="0">
                                        <tr>
                                            <td>
                                ...
                                <td><!--- #variables.winner_name_after# (#variables.winner_after#)<br />Donor ID = #qry_qry_winner_after.id# --->
                                    <table border="0" cellpadding="1" cellspacing="0">
                                        <tr>
                                            <td>
                        ...
                        <cfform name="send_email" action="gen_email.cfm" method="post" enablecab="Yes" onSubmit="return rusureform('#confirmation#')">
                            <table border="0" cellpadding="3" cellspacing="3">
                                <tr>
                                    <td>
                                        <cfinput type="submit" name="submit" value="Generate Email Notifications" validate="SubmitOnce">
