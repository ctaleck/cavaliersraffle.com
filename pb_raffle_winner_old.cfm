...
<cfquery name="selUsedNumbers" datasource="#request.datasource#">
    ...
    <div class="container-fluid py-5">
        ...
        <div class="entry">  
            <cfif NOT IsDefined("form.winning_number")>
                <cfform name="quote_request" action="pb_raffle_winner_old.cfm" method="post">
                    <cfoutput>
                    <table border="0" cellpadding="3" cellspacing="3">					
                        ...
                        <tr>
                            <td> 
                                <cfinput class="form-control" type="text"
                                            name="winning_number"
                                            size="4"
                                            maxlength="5">
                            </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <cfinput class="btn btn-success" type="submit" name="submit" value="Submit" validate="SubmitOnce">
                            </td>
                        </tr>
                    </table>
                    </cfoutput>
                ...
                <h2>Raffle Number Generator</h2>
                    ...
                    <form method="get" action="/" onSubmit="return false;">
                        ...
                        <textarea style="width: 100%;height: 150px;" name="things" id="things">#variables.eligible_number_list#</textarea>
                        
                        <textarea style="width: 100%;height: 150px;" name="thing" id="thing">#variables.eligible_number_list#</textarea>
                    
                        <p>
                            <input class="btn btn-success" type="button" value="Get This Month's Number!" onClick="rnd();">
                            <img id="ajax-loader" src="images/ajax-loader.gif" alt="Picking...">
                        </p>
                    </form> 
                    </cfoutput>
                <script type="text/javascript">
                ...
                <h2>Result</h2>
                <div id="result">Raffle Number Will Display Here</div>
