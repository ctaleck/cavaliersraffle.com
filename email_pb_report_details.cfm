...
If you do not get an email on the first Friday (by end of the day), check your junk or spam folder
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: ##35355A;">
    ...
    <!--[if mso | IE]>
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: ##35355A;">
    <tr>
    <td>
    <![endif]-->
        ...
        <div style="max-width: 600px; margin: 0 auto;" class="email-container">
            ...
            <tr>
                <td style="background-color: ##ffffff;">
                    <img src="http://cavaliersraffle.com/images/cavaliers-raffle-email.jpg" width="600" height="300" alt="Cavaliers Raffle logo" border="0" style="width: 100%; max-width: 600px; height: auto; background: ##dddddd; font-family: sans-serif; font-size: 15px; line-height: 15px; color: ##555555; margin: auto; display: block;" class="g-img">
                </td>
            </tr>
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: ##555555;">
                ...
                <p style="margin-left: 20px; margin-right: 20px; font-size: 20px;">
                    #variables.raffle_list#
                </p>
                <p>
                    Your eligibility raffle drawing dates are:
...
<!-- Email Body Content Sample : END -->
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: sans-serif; font-size: 12px; line-height: 20px; color: ##555555;">
                                    <p style="margin: 0;">
                                        If you do <em>not</em> get an email on the first Friday of the month 
                                        (by end of the day), check your junk or spam folder for the email
                                        and mark it as "not spam" so that you'll receive them in the future.
                                    </p>
                                </td>
                            </tr>
                        </table>
	        ...
	        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                <tr>
                    <td style="padding: 20px; font-family: sans-serif; font-size: 12px; line-height: 15px; text-align: center; color: ##ffffff;">
                        <br><br>
                        Our Lady of Sorrows Academy<br>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: ##35355A;">
            <tr>
                <td>
                    <div align="center" style="max-width: 600px; margin: auto;" class="email-container">
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; text-align: left; font-family: sans-serif; font-size: 12px; line-height: 20px; color: ##888888;">
                                    <p style="margin: 0;">
