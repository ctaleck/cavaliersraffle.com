			...
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
                        ...
                        <h2 class="title">Email Generation Report</strong></h2>
		...
		<!--- ****** The following code is what generates the email report displayed as well as the email addresses that will be sent out ****** --->
                            ...
                            <cfoutput>
                                <table border="1" cellpadding="0" cellspacing="0" width="125%">
                                    <tr>
                                        <th style="font-size:18px; text-align:center">The following emails were generated and sent to the email addresses shown</th>
                                    </tr>
                                    <tr>
                                        <th>Raffle Winner</th>
                                    </tr>
                                    <tr>
                                        <td style="text-align:left">#variables.winner_first# #variables.winner_last_full#<br />#variables.winner_email#</td>
                                    </tr>
                                    <tr><td>&nbsp;</td></tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="text-align:left">#variables.winner_before_first# #variables.winner_before_last_full#<br />#variables.winner_before_email#</td>
                                    </tr>
                                    <tr><td>&nbsp;</td></tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="text-align:left">#variables.winner_after_first# #variables.winner_after_last_full#<br />#variables.winner_after_email#</td>
                                    </tr>
                                    <tr><td>&nbsp;</td></tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="text-align:left">#variables.nonWinningEmailList1# #variables.nonWinningEmailList2# #variables.nonWinningEmailList3# #variables.nonWinningEmailList4# #variables.nonWinningEmailList5#</td>
                                    </tr>							
                                    <tr><td>&nbsp;</td></tr>
                                    <tr>
                                    	<th>Notification to Office (Julie)</th>
                                    </tr>
                                    <tr>
                                        <td style="text-align:left">juliejhoffman26@gmail.com</td>
                                    </tr>
                                    <tr><td>&nbsp;</td></tr>
                                    <tr>
